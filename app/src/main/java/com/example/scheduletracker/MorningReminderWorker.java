...
public class MorningReminderWorker extends Worker {
    ...
    public MorningReminderWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        showNotification("Good Morning!", "Time to check your tasks for the day.");
